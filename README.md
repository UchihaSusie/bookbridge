...
[![BookBridge Screenshot](docs/thumbnail.png)](https://bookbridge-henna.vercel.app/)
...
├── bookbridge/               # Python Worker package (ingestion, glossary, harness, quality, worker_api)
